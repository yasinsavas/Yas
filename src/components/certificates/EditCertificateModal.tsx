...
function EditCertificateModal({ isOpen, onClose, certificate }: EditCertificateModalProps) {
  const [rating, setRating] = useState(certificate.rating || 5);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('Updated Data:', { ...formData, rating });
    onClose();
  };
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Sertifika Düzenle" maxWidth="max-w-4xl">
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex items-start gap-4 p-4 bg-[#0a2351]/5 rounded-lg">
          ...
          <div>
            ...
            <p className="text-sm text-[#0a2351]/70">Sertifika bilgilerini güncelleyin</p>
          </div>
        </div>
